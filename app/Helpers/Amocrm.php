...
class Amocrm
{
    ...
    public $STATUS_TRIAL_REQUEST = 28009120;
    public $STATUS_QUESTIONNAIRE = 28009219;
    public $STATUS_QUESTIONNAIRE_DONE = 28009225;
    public $STATUS_TRIAL_SCHEDULED = 28009231;
    public $STATUS_NO_SHOW_CANCELLED = 28009237;
    public $STATUS_TRIAL_COMPLETED = 28009240;
    public $STATUS_NO_REPLY_AFTER_TRIAL = 28009243;
    public $STATUS_THINKING_DECISION = 28009246;
    public $STATUS_FIRST_MEMBERSHIP_SCHEDULED = 28009255;
    public $STATUS_NO_SHOW_FIRST_MEMBERSHIP = 28009258;
    public $STATUS_FIRST_MEMBERSHIP_DONE = 28009261;
    public $STATUS_PURCHASED = 142;
    public $STATUS_NO_PURCHASE = 143;
    public $CUSTOM_FIELD_LANGUAGE = 123969;
    public $CUSTOM_FIELD_EMAIL = 95929;

    protected $settings;
    protected $subdomain;
    protected $auth;

    public $STAGE_PURCHASED = 2073790;
    public $STAGE_4_WEEKS = 2111944;
    public $STAGE_3_WEEKS = 2111947;
    public $STAGE_2_WEEKS = 2111950;
    public $STAGE_1_WEEKS = 2111953;
    public $STAGE_MEMBERSHIP_FINISHED = 2111956;
    public $STAGE_INTERESTED_TO_RENEW = 2111962;
    public $STAGE_NO_MORE_INTEREST = 2111965;

    public $END_SUBSCRIPTIONS_DAY = 133915;

    public $LEAD_LANGUAGE = 149153;
    public $CONTACT_LANGUAGE = 123969;

    public $CONTACT_LANG_EN = 164835;
    public $CONTACT_LANG_AR = 164837;
    ...
    public function getContactLang($contact): string
    {
